Contributing to OneWorld Core
============================

The OneWorld Core project operates an open contributor model where anyone is
...
the pull request affects. Valid areas as:
  ...
  - *Tests* for changes to the OneWorld unit tests or QA tests
...
[Translation Process](https://github.com/OneWorld-project/OneWorld/blob/master/doc/translation_process.md)
...
The following applies to code changes to the OneWorld Core project, and is not to be
confused with overall OneWorld Network Protocol consensus changes.

Whether a pull request is merged into OneWorld Core rests with the project merge
...
Patches that change OneWorld consensus rules are considerably more involved than
...
Where a patchset proposes to change the OneWorld consensus, it must have been
...
The project leader is the release manager for each OneWorld Core release.
