...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop OneWorld server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "OneWorld server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* OneWorld features */
        {"OneWorld", "listmasternodes", &listmasternodes, true, true, false},
        {"OneWorld", "getmasternodecount", &getmasternodecount, true, true, false},
        {"OneWorld", "masternodeconnect", &masternodeconnect, true, true, false},
        {"OneWorld", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"OneWorld", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"OneWorld", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"OneWorld", "masternodecurrent", &masternodecurrent, true, true, false},
        {"OneWorld", "masternodedebug", &masternodedebug, true, true, false},
        {"OneWorld", "startmasternode", &startmasternode, true, true, false},
        {"OneWorld", "createmasternodekey", &createmasternodekey, true, true, false},
        {"OneWorld", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"OneWorld", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"OneWorld", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"OneWorld", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"OneWorld", "getmasternodescores", &getmasternodescores, true, true, false},
        {"OneWorld", "preparebudget", &preparebudget, true, true, false},
        {"OneWorld", "submitbudget", &submitbudget, true, true, false},
        {"OneWorld", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"OneWorld", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"OneWorld", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"OneWorld", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"OneWorld", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"OneWorld", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"OneWorld", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"OneWorld", "checkbudgets", &checkbudgets, true, true, false},
        {"OneWorld", "mnsync", &mnsync, true, true, false},
        {"OneWorld", "spork", &spork, true, true, false},
        {"OneWorld", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzOWOseed", &getzOWOseed, false, false, true},
        {"zerocoin", "setzOWOseed", &setzOWOseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzOWO", &searchdzOWO, false, false, true},
        {"zerocoin", "dzOWOstate", &dzOWOstate, false, false, true},
...
{
    return "> OneWorld-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:32113/\n";
}
