...
#ifndef OneWorld_ZOWOTRACKER_H
#define OneWorld_ZOWOTRACKER_H
...
public:
    CzOWOTracker(std::string strWalletFile);
    ~CzOWOTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzOWOWallet* zOWOWallet = NULL);
