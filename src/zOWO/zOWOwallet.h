...
#ifndef OneWorld_ZOWOWALLET_H
#define OneWorld_ZOWOWALLET_H
...
public:
    CzOWOWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZOWO(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZOWO(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
