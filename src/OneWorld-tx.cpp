...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("OneWorld Core OneWorld-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  OneWorld-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded OneWorld transaction") + "\n" +
                               "  OneWorld-tx [options] -create [commands]   " + _("Create hex-encoded OneWorld transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded OneWorld transaction
