...
public:
    ...
    int OneWorldBadBlockTime() const { return nOneWorldBadBlockTime; }
    int OneWorldBadBlocknBits() const { return nOneWorldBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nOneWorldBadBlockTime;
    unsigned int nOneWorldBadBlocknBits;
