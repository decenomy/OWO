    ...
    ui(new Ui::DashboardWidget)
{
    ...
    // Staking Information
    ui->labelMessage->setText(tr("Amount of OWO earned via Staking & Masternodes"));
	...
	ui->labelAmountMNRewards->setText("0 OWO");
...
bool DashboardWidget::loadChartData(bool withMonthNames)
{
    ...
    chartData->amountsByCache = getAmountBy(); // pair OWO
...
void DashboardWidget::onChartRefreshed()
{
    ...
    set0->setColor(QColor(255, 230, 108));
	set1->setColor(QColor(5, 138, 204));
