...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("OneWorld Core"),
     ...
     * override -datadir in the OneWorld.conf file in the default data directory
     * (to be consistent with OneWorldd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
