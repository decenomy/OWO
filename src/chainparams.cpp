...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x00000e7b446b97413bfec60b4d733b3765dcc2bbbb63fd655e507390e4c4632c")); //!< Network split here
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1590602436, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("04cece55b294c8d6926dcacb21719c3b052615ea2ed4556a005198c8aacce4535209edba0d6e5ea7e3dcaeb37697a0c63747d52de9f7fa8bd8fc23073ced678fd8");
        nDefaultPort = 32112;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // OneWorld starting difficulty is 1 / 2^12
        ...
        nLastPOWBlock = 200;
        nOneWorldBadBlockTime = 1471401614; // Skip nBit validation of Block 259201 per PR #915
        nOneWorldBadBlocknBits = 0x1c056dac; // Skip nBit validation of Block 259201 per PR #915
        nModifierUpdateBlock = 999999999;
        nZerocoinStartHeight = 999999999;
        nZerocoinStartTime = 4744106632; // October 17, 2017 4:30:00 AM
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("045cc0738b254d30b688352a0866ce76f5c07d1770bd07460049a327f00c1921705f130ce64d28e83c24c7fc1b0b63958ab9b883131dcdb4dca5655e1e17350a6c") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 4;
        genesis.nTime = 1590602436;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 8798527;

        hashGenesisBlock = uint256("0x00000e7b446b97413bfec60b4d733b3765dcc2bbbb63fd655e507390e4c4632c");
        ...
        assert(hashGenesisBlock == uint256("0x00000e7b446b97413bfec60b4d733b3765dcc2bbbb63fd655e507390e4c4632c"));
        assert(genesis.hashMerkleRoot == uint256("0xd5815c170eb44b9b7aaf67a76cba9da647ec1ade573c585c665a627a71b5405e"));

	      vSeeds.push_back(CDNSSeedData("149.28.146.108", "149.28.146.108"));
        vSeeds.push_back(CDNSSeedData("212.237.18.147", "212.237.18.147"));
        vSeeds.push_back(CDNSSeedData("80.211.89.44", "80.211.89.44"));
        vSeeds.push_back(CDNSSeedData("89.46.67.187", "89.46.67.187"));
        vSeeds.push_back(CDNSSeedData("89.46.67.187", "89.46.67.187"));
        ...
        nZerocoinRequiredStakeDepth = 200; //The required confirmations for a zOWO to be stakable
...
{
	return "oe66MM1QtCJWAJeqowZ6ssnzUfc3ELqdRY";
}
...
public:
    CTestNetParams()
    {
        ...
        nLastPOWBlock = 200;
        nOneWorldBadBlockTime = 1489001494; // Skip nBit validation of Block 259201 per PR #915
        nOneWorldBadBlocknBits = 0x1e0a20bd; // Skip nBit validation of Block 201 per PR #915
        nMaturity = 15;
        nStakeMinDepth = 100;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "OneWorld-testnet.seed.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "OneWorld-testnet.seed2.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("warrows.dev", "testnet.dnsseed.OneWorld.warrows.dev"));
