...
1. Clone the OneWorld Core source code:

        git clone https://github.com/OneWorld-project/OneWorld
        cd OneWorld
...
OneWorld Core is now available at `./src/OneWorldd`

Before running, you may create an empty configuration file:

    mkdir -p "/Users/${USER}/Library/Application Support/OneWorld"

    touch "/Users/${USER}/Library/Application Support/OneWorld/OneWorld.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/OneWorld/OneWorld.conf"

The first time you run OneWorldd, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.
...
-------
    ...
    ./src/OneWorldd -daemon # Starts the OneWorld daemon.
    ./src/OneWorld-cli --help # Outputs a list of command-line options.
    ./src/OneWorld-cli help # Outputs a list of RPC commands when the daemon is running.
