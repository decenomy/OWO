...
from fake_stake.base_test import OneWorld_FakeStakeTest

class zOWOValidCoinSpendTest(OneWorld_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zOWOs..." % DENOM_TO_USE)
